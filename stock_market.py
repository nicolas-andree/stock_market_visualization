...
#Nicolas Andree, adapted from Scikit Learn website
...
#with a functioning data interface (read from file, insead of google finance which is not working anymore)
#source data: NYSE daily prices from 1962 - 1984 
# Results:
# Cluster 1: comme
# Cluster 2: espey
...
# Cluster 10: pills
# Cluster 11: sherw
# Fixes to original code: (1) imported data from file as google finance not working anymore
# (2) plt.cm.nipy_spectral instead of plt.cm.spectral
# Conclusion: the algorithm does not work as nicely on this dataset, as it only identifies single stocks
# oil stocks and puts all the rest in one cluster
